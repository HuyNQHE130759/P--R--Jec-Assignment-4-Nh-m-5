<template>
    <div>
        <div class="login-header flex items-center justify-between p-8">
            ...
            <div class="flex">
                <ElInput placeholder="What do you want to learn">
                    <ElButton slot="append" icon="el-icon-search"></ElButton>
                </ElInput>
            </div>
        </div>
        <div class="w-1/2 m-auto border border-gray-300 p-16 rounded-lg text-center login-content flex my-8">
            <div class="w-full m-auto">
                <div class="flex justify-center"><img src="~/assets/images/fpt-login.png" /></div>
                <div class="my-8">
                ...
                <div class="flex items-center justify-between m-auto w-1/2">
                    <ElButton><i class="fab fa-google mr-2" style="color:#e94820"/>Login with Google</ElButton>
                    <ElButton class="text-red-600"> Forgot password </ElButton>
                </div>
            </div>
        </div>
